...
ccflags=' -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/scratch/petalinux-yocto/yocto_downloads_2019.1_zynq-generic/build_zynq-generic/tmp/work/cortexa9t2hf-neon-xilinx-linux-gnueabi/perl/5.24.4-r0=/usr/src/debug/perl/5.24.4-r0 -fdebug-prefix-map=FIXMESTAGINGDIRTARGET= -fdebug-prefix-map=FIXMESTAGINGDIRHOST=  -DDEBIAN -D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
ccflags_uselargefiles=' -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/scratch/petalinux-yocto/yocto_downloads_2019.1_zynq-generic/build_zynq-generic/tmp/work/cortexa9t2hf-neon-xilinx-linux-gnueabi/perl/5.24.4-r0=/usr/src/debug/perl/5.24.4-r0 -fdebug-prefix-map=FIXMESTAGINGDIRTARGET= -fdebug-prefix-map=FIXMESTAGINGDIRHOST=  -DDEBIAN -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
ccname="arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard -mcpu=cortex-a9 -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security --sysroot=FIXMESTAGINGDIRTARGET"
ccsymbols=''
ccversion=''
cf_by='Open Embedded'
...
cpplast='-'
cppminus='-'
cpprun="arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard -mcpu=cortex-a9 -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security --sysroot=FIXMESTAGINGDIRTARGET -E"
cppstdin="arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard -mcpu=cortex-a9 -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security --sysroot=FIXMESTAGINGDIRTARGET -E"
