...
tie %Config, 'Config', {
    ...
    archlibexp => 'FIXMESTAGINGDIRTARGET/usr/lib/perl/5.24.4/',
    archname => 'arm-linux-gnueabi',
    cc => 'arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard -mcpu=cortex-a9 -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security --sysroot=FIXMESTAGINGDIRTARGET',
    cccdlflags => '-fPIC',
    ...
    eunicefix => ':',
    exe_ext => '',
    full_ar => 'FIXMESTAGINGDIRHOST/usr/bin/arm-xilinx-linux-gnueabi/arm-xilinx-linux-gnueabi-ar',
    inc_version_list => ' ',
    installman1dir => '',
    installman3dir => '',
    ...
    intsize => '4',
    ld => 'arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard -mcpu=cortex-a9 -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security --sysroot=FIXMESTAGINGDIRTARGET',
