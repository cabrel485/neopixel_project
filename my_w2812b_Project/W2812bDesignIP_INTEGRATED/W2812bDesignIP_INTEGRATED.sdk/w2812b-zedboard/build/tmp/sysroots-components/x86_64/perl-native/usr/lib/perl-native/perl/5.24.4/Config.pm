...
tie %Config, 'Config', {
    archlibexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl-native/perl/5.24.4',
    ...
    path_sep => ':',
    privlibexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl-native/perl/5.24.4',
    scriptdir => 'FIXMESTAGINGDIRHOST/usr/bin/perl-native',
    sitearchexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl-native/perl/site_perl/5.24.4',
    sitelibexp => 'FIXMESTAGINGDIRHOST/usr/lib/perl-native/perl/site_perl/5.24.4',
    so => 'so',
    useithreads => 'define',
