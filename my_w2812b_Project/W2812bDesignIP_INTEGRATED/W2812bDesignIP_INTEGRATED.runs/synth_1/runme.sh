...
HD_PWD='/home/wilson/Documents/Project/my_w2812b_Project/W2812bDesignIP_INTEGRATED/W2812bDesignIP_INTEGRATED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log W2812b_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source W2812b_design_1_wrapper.tcl
